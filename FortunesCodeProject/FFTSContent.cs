...
namespace FortunesFromTheScrapyard
{
    public class FFTSContent : IContentPackProvider
    {
        ...
        {
            var enumerator = FFTSAssets.Initialize();
        ...
        private static IEnumerator LoadFromAssetBundles()
        {
            ...
            */
            ...
            FFTSLog.Info($"Calling AsyncAssetLoad Attribute Methods...");
            ParallelMultiStartCoroutine asyncAssetLoadCoroutines = AsyncAssetLoadAttribute.CreateCoroutineForMod(FFTSMain.instance);
        ...
        private static IEnumerator LoadVanillaSurvivorBundles()
        {
            ...
            var list = new List<FFTSVanillaSurvivor>()
            {
                //Add the rest
            };
        ...
        {
            FFTSAssetRequest<ExpansionDef> request = FFTSAssets.LoadAssetAsync<ExpansionDef>("ScrapyardExpansionDef", FFTSBundle.Main);
        ...
        internal FFTSContent()
        {
            ...
            FFTSAssets.onScrapyardAssetsInitialized += () =>
            {
        ...
        static FFTSContent()
        {
            FFTSMain main = FFTSMain.instance;
        ...
        {
            public static ItemDef BrokenHeadphones;
            ...
            public static ItemDef LostRecord;
        ...
        public static class Buffs
        {
            ...
            public static BuffDef bdBrokenHeadphonesDisorient;
        ...
        {
            public static ModdedProcType BrokenHeadphones;
            public static ModdedProcType SprayCan;
            public static ModdedProcType MoonshineFlask;
        }
