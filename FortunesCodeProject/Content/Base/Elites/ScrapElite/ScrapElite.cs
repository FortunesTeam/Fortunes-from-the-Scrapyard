...
namespace FortunesFromTheScrapyard.Elite
{
    public sealed class ScrapElite : FFTSEliteEquipment
    {
        ...
        public override FFTSAssetRequest<EliteAssetCollection> LoadAssetRequest()
        {
            return FFTSAssets.LoadAssetAsync<EliteAssetCollection>("acScrapElite", FFTSBundle.Elites);
        }
        ...
        {
            if (NetworkServer.active && body.HasBuff(FFTSContent.Buffs.bdEliteScrap)) body.RemoveBuff(FFTSContent.Buffs.bdEliteScrap);

        }

        public override void OnEquipmentObtained(CharacterBody body)
        {
            if (NetworkServer.active) body.AddBuff(FFTSContent.Buffs.bdEliteScrap);
        }

        public class ScrapEliteBehaviour : BaseBuffBehaviour
        {
            [BuffDefAssociation]
            public static BuffDef GetBuffDef() => FFTSContent.Buffs.bdEliteScrap;
