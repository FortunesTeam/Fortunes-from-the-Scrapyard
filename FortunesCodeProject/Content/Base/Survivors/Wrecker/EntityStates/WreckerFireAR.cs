...
{
    public class WreckerFireAR : BaseSkillState
    {
        public static float damageCoefficient = WreckerSurvivor.basePrimaryDamage;
        public static float procCoefficient = 1f;
        public static float baseDuration = 0.1f; // per shot
        public static float baseFullDuration = 1.2f; // FULL SKILL DURATION. This is to add delay between bursts
        ...
        protected virtual float _damageCoefficient => WreckerFireAR.damageCoefficient;
        protected virtual GameObject tracerPrefab => this.isCrit ? WreckerFireAR.critTracerEffectPrefab : WreckerFireAR.tracerEffectPrefab;
        ...
        public override void OnEnter()
        {
            ...
            this.duration = WreckerFireAR.baseDuration / this.attackSpeedStat;
        ...
        private void Fire()
        {
            ...
            if (base.isAuthority)
            {
                ...
                base.AddRecoil(-1f * WreckerFireAR.recoil, -1f * WreckerFireAR.recoil, -0.5f * WreckerFireAR.recoil, 0.5f * WreckerFireAR.recoil);
                ...
                BulletAttack bulletAttack = new BulletAttack
                {
                    ...
                    maxDistance = WreckerFireAR.range,
                    force = WreckerFireAR.force,
