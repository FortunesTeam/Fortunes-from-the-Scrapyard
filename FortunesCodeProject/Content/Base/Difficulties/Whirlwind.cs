...
namespace FortunesFromTheScrapyard
{
    public class Whirlwind : FFTSDifficulty
    {
        ...
        public class BeetleGuard
        {
            ...
            public static void Init()
            {
                ...
                IL.EntityStates.BeetleGuardMonster.FireSunder.FixedUpdate += (il) =>
                {
                    ...
                    {
                        FFTSLog.Debug("Whirlwind: EntityStates.BeetleGuardMonster.FireSunder.FixedUpdate IL Hook failed");
                    }
                };
            }
        ...
        public class Bronzong
        {
            ...
            public static void Init()
            {
                ...
                IL.EntityStates.Bell.BellWeapon.ChargeTrioBomb.FixedUpdate += (il) =>
                {
                    ...
                    {
                        FFTSLog.Debug("Whirlwind: EntityStates.Bell.BellWeapon.ChargeTrioBomb.FixedUpdate IL Hook failed");
                    }
                };
            }
            public static void UnInit()
        ...
        public class ClayBoss
        {
            ...
            public static void Init()
            {
                ...
                IL.EntityStates.ClayBoss.ClayBossWeapon.FireBombardment.FireGrenade += (il) =>
                {
                    ...
                    {
                        FFTSLog.Debug("Whirlwind: EntityStates.ClayBoss.ClayBossWeapon.FireBombardment.FireGrenade IL Hook failed");
                    }
                };
            }
            public static void UnInit()
        ...
        public class FlyingVermin
        {
            ...
            public static void Init()
            {
                ...
                IL.EntityStates.GenericProjectileBaseState.FireProjectile += (il) =>
                {
                    ...
                    {
                        FFTSLog.Debug("Whirlwind: FlyingVermin EntityStates.GenericProjectileBaseState.FireProjectile IL Hook failed");
                    }
                };
            }
            public static void UnInit()
        ...
        public class GreaterWisp
        {
            ...
            public static void Init()
            {
                ...
                IL.EntityStates.GreaterWispMonster.FireCannons.OnEnter += (il) =>
                {
                    ...
                    {
                        FFTSLog.Debug("Whirlwind: EntityStates.GreaterWispMonster.FireCannons.OnEnter IL Hook failed");
                    }
                };
            }
            public static void UnInit()
        ...
        public class Grovetender
        {
            ...
            public static void Init()
            {
                ...
                IL.EntityStates.GravekeeperBoss.FireHook.OnEnter += (il) =>
                {
                    ...
                    {
                        FFTSLog.Debug("Whirlwind: EntityStates.GravekeeperBoss.FireHook.OnEnter IL Hook failed");
                    }
                };
            }
            public static void UnInit()
        ...
        public class Lemurian
        {
            ...
            public static void Init()
            {
                ...
                IL.EntityStates.LemurianMonster.FireFireball.OnEnter += (il) =>
                {
                    ...
                    {
                        FFTSLog.Debug("Whirlwind: EntityStates.LemurianMonster.FireFireball.OnEnter IL Hook failed");
                    }
                };
            }
        ...
        public class LemurianBruiser
        {
            ...
            public static void Init()
            {
                ...
                IL.EntityStates.LemurianBruiserMonster.FireMegaFireball.FixedUpdate += (il) =>
                {
                    ...
                    {
                        FFTSLog.Debug("Whirlwind: EntityStates.LemurianBruiserMonster.FireMegaFireball.FixedUpdate IL Hook failed");
                    }
                };
            }
            public static void UnInit()
        ...
        public class LunarExploder
        {
            ...
            public static void Init()
            {
                ...
                IL.EntityStates.GenericProjectileBaseState.FireProjectile += (il) =>
                {
                    ...
                    {
                        FFTSLog.Debug("Whirlwind: LunarExploder EntityStates.GenericProjectileBaseState.FireProjectile IL Hook failed");
                    }
                };
            }
            public static void UnInit()
        ...
        public class MinorConstruct
        {
            ...
            public static void Init()
            {
                ...
                IL.EntityStates.GenericProjectileBaseState.FireProjectile += (il) =>
                {
                    ...
                    {
                        FFTSLog.Debug("Whirlwind: MinorConstruct EntityStates.GenericProjectileBaseState.FireProjectile IL Hook failed");
                    }
                };
            }
            public static void UnInit()
        ...
        public class RoboBallBoss
        {
            ...
            public static void Init()
            {
                ...
                IL.EntityStates.RoboBallBoss.Weapon.FireEyeBlast.FixedUpdate += (il) =>
                {
                    ...
                    {
                        FFTSLog.Debug("Whirlwind: EntityStates.RoboBallBoss.Weapon.FireEyeBlast.FixedUpdate IL Hook failed");
                    }
                };
            }
            public static void UnInit()
        ...
        public class Scavenger
        {
            ...
            public static void Init()
            {
                ...
                IL.EntityStates.ScavMonster.FireEnergyCannon.OnEnter += (il) =>
                {
                    ...
                    {
                        FFTSLog.Debug("Whirlwind: EntityStates.ScavMonster.FireEnergyCannon.OnEnter IL Hook failed");
                    }
                };
            }
            public static void UnInit()
        ...
        public class Vagrant
        {
            ...
            public static void Init()
            {
                ...
                IL.EntityStates.VagrantMonster.Weapon.JellyBarrage.FixedUpdate += (il) =>
                {
                    ...
                    if (error)
                    {
                        FFTSLog.Debug("Whirlwind: EntityStates.VagrantMonster.Weapon.JellyBarrage.FixedUpdate IL Hook failed");
                    }
                };
            }
            public static void UnInit()
        ...
        public class Vulture
        {
            ...
            public static void Init()
            {
                ...
                IL.EntityStates.Vulture.Weapon.FireWindblade.OnEnter += (il) =>
                {
                    ...
                    {
                        FFTSLog.Debug("Whirlwind: EntityStates.Vulture.Weapon.FireWindblade.OnEnter IL Hook failed");
                    }
                };
            }
            public static void UnInit()
        ...
        public static Ray PredictAimrayPS(Ray aimRay, TeamIndex attackerTeam, float maxTargetAngle, GameObject projectilePrefab, HurtBox targetHurtBox)
        {
            ...
            if (speed <= 0f)
            {
                FFTSLog.Debug("Whirlwind: Could not get speed of ProjectileSimple.");
                return aimRay;
            }
        ...
        public static Ray PredictAimrayPCC(Ray aimRay, TeamIndex attackerTeam, float maxTargetAngle, GameObject projectilePrefab, HurtBox targetHurtBox)
        {
            ...
            if (speed <= 0f)
            {
                FFTSLog.Debug("Whirlwind: Could not get speed of ProjectileCharacterController.");
                return aimRay;
            }
