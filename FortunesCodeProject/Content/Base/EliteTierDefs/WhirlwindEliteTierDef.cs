...
{
    public class WhirlwindEliteTierDef : FFTSEliteTier
    {
        public override FFTSAssetRequest<SerializableEliteTierDef> AssetRequest => FFTSAssets.LoadAssetAsync<SerializableEliteTierDef>("WhirlwindSpecialEliteTierDef", FFTSBundle.Elites);
