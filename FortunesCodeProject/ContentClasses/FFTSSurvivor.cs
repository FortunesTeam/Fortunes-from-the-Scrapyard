...
namespace FortunesFromTheScrapyard
{
    ...
    /// </summary>
    public abstract class FFTSSurvivor : ISurvivorContentPiece, IContentPackModifier
    {
        ...
        public abstract FFTSAssetRequest<SurvivorAssetCollection> LoadAssetRequest();

        public virtual IEnumerator LoadContentAsync()
        {
            FFTSAssetRequest<SurvivorAssetCollection> request = LoadAssetRequest();
