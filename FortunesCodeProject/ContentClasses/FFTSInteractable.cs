...
namespace FortunesFromTheScrapyard
{
    ...
    /// </summary>
    public abstract class FFTSInteractable : IInteractableContentPiece, IContentPackModifier
    {
        ...
        public abstract FFTSAssetRequest<InteractableAssetCollection> LoadAssetRequest();
        public virtual IEnumerator LoadContentAsync()
        {
            FFTSAssetRequest<InteractableAssetCollection> request = LoadAssetRequest();
