...
namespace FortunesFromTheScrapyard
{
    ...
    /// </summary>
    public abstract class FFTSItemTier : IItemTierContentPiece, IContentPackModifier
    {
        ...
        public abstract FFTSAssetRequest<ItemTierAssetCollection> LoadAssetRequest();
        public abstract void Initialize();
        public abstract bool IsAvailable(ContentPack contentPack);

        public virtual IEnumerator LoadContentAsync()
        {
            FFTSAssetRequest<ItemTierAssetCollection> request = LoadAssetRequest();
