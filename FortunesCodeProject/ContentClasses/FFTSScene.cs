...
{
    public abstract class FFTSScene : ISceneContentPiece, IContentPackModifier
    {
        ...
        public abstract FFTSAssetRequest<SceneAssetCollection> LoadAssetRequest();

        public virtual IEnumerator LoadContentAsync()
        {
            FFTSAssetRequest<SceneAssetCollection> request = LoadAssetRequest();
