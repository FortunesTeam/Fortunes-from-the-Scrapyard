...
namespace FortunesFromTheScrapyard
{
    ...
    /// </summary>
    public abstract class FFTSMonster : IMonsterContentPiece, IContentPackModifier
    {
        ...
        public abstract FFTSAssetRequest<MonsterAssetCollection> LoadAssetRequest();
        public virtual IEnumerator LoadContentAsync()
        {
            FFTSAssetRequest<MonsterAssetCollection> request = LoadAssetRequest();
