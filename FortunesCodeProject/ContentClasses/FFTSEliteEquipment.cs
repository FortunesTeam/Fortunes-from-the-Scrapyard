...
namespace FortunesFromTheScrapyard
{
    ...
    /// </summary>
    public abstract class FFTSEliteEquipment : IEliteContentPiece, IContentPackModifier
    {
        /// <summary>
        ...
        public abstract FFTSAssetRequest<EliteAssetCollection> LoadAssetRequest();
        public abstract void Initialize();
        public abstract bool IsAvailable(ContentPack contentPack);
        public virtual IEnumerator LoadContentAsync()
        {
            FFTSAssetRequest<EliteAssetCollection> request = LoadAssetRequest();
