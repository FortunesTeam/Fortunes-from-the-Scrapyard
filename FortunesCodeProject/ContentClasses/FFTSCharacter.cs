...
namespace FortunesFromTheScrapyard
{
    ...
    /// </summary>
    public abstract class FFTSCharacter : ICharacterContentPiece, IContentPackModifier
    {
        ...
        public abstract FFTSAssetRequest<BodyAssetCollection> LoadAssetRequest();
        public virtual IEnumerator LoadContentAsync()
        {
            FFTSAssetRequest<BodyAssetCollection> request = LoadAssetRequest();
