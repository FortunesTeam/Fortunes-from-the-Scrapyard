...
namespace FortunesFromTheScrapyard.Monsters.SporebackCrab
{
    public class SporebackCrabMonster : ScrapyardMonster
    {
        // lol I have no CLUE what I'm doing, If ANY of this looks right it by the grace of God or Kenko - EZ


        public const string PRIMARYTOKEN = "SCRAPYARD_SPOREBACKCRAB_PRIMARY_DESC";
        public const string SECONDARYTOKEN = "SCRAPYARD_SPOREBACKCRAB_SECONDARY_DESC";
        public const string UTILITYTOKEN = "SCRAPYARD_SPOREBACKCRAB_UTILITY_DESC";
        public const string SPECIALTOKEN = "SCRAPYARD_SPOREBACKCRAB_SPECIAL_DESC";
        ...
        // DamageTypes
        public static DamageAPI.ModdedDamageType CrabAcid;
        ...
        {
            return ScrapyardAssets.LoadAssetAsync<MonsterAssetCollection>("acSporebackCrab", ScrapyardBundle.Indev);
        }
