...
namespace FortunesFromTheScrapyard.Items
{
    public class FaultyTurbo : ScrapyardItem
    {
        ...
        public static float movespeedBonus = 0.6f;
        ...
        [ConfigureField(ScrapyardConfig.ID_ITEMS)]
        [FormatToken(TOKEN, 2)]
        public static float baseDurationStack = 1.5f;
        ...
        {
            return ScrapyardAssets.LoadAssetAsync<ItemAssetCollection>("acFaultyTurbo", ScrapyardBundle.Indev);
        }
